...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `https://www.r2g.com.au/removalists-brisbane/${suburb.slug}` },
    openGraph: {
...
function getFaqItems(suburb: BrisbaneSuburb) {
  const genericFaqs = [
    {
...
export default async function RemovalistsBrisbaneSuburbPage({
  ...
  const businessSchema = {
    ...
    description: `Fully insured removalists in ${suburb.name}, Brisbane. 4.8-star rated with 830+ reviews. 10+ years experience.`,
    url: `https://www.r2g.com.au/removalists-brisbane/${suburb.slug}`,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Removalists Brisbane", item: "https://www.r2g.com.au/removalists-brisbane" },
      { "@type": "ListItem", position: 3, name: `Removalists ${suburb.name}`, item: `https://www.r2g.com.au/removalists-brisbane/${suburb.slug}` },
    ],
  };
  ...
  const localBusinessSchema = {
    ...
    description: `Fully insured removalist services in ${suburb.name}, Brisbane. 4.8-star rated with 830+ reviews.`,
    url: `https://www.r2g.com.au/removalists-brisbane/${suburb.slug}`,
    telephone: "1300 959 498",
    email: "contact@r2g.com.au",
    image: "https://www.r2g.com.au/images/r2g-logo.png",
