            ...
            <div>
              ...
              <div className="relative h-72 sm:h-80 rounded-2xl overflow-hidden shadow-lg mb-8">
                <Image
                  ...
                  alt="R2G removalists loading truck for a Cairns home move - professional removalist service"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-12 lg:gap-16 items-center">
            ...
            <div className="relative h-[420px] lg:h-[540px] rounded-2xl overflow-hidden shadow-lg">
              <Image
                ...
                alt="R2G removalists packing and wrapping furniture for a Cairns move"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-[#1A1A1A]">
              What Cairns Customers Say About R2G
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                text: "R2G moved our whole 4-bedroom home from Edge Hill to Redlynch without a single scratch. The boys were professional, fast and genuinely careful with everything. They even helped us set up the beds at the end. Absolutely outstanding service.",
                name: "Jason & Mel T.",
                location: "Edge Hill → Redlynch",
                date: "February 2025",
              },
              {
                text: "Used R2G for an interstate move from Cairns to Brisbane. They wrapped everything perfectly, the truck arrived on time and nothing was damaged. Pricing was exactly as quoted. Would use them again without hesitation.",
                name: "Priya S.",
                location: "Cairns → Brisbane",
                date: "January 2025",
              },
              {
                text: "Second time using R2G and they were just as good as the first. Moved our office in Cairns CBD — efficient, no damage to equipment or furniture, and the team was friendly and professional throughout. Highly recommend.",
                name: "David K.",
                location: "Cairns CBD",
                date: "December 2024",
              },
