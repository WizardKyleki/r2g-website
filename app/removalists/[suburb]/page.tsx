...
function getFaqItems(suburbName: string) {
  return [
    ...
    },
    {
      ...
      answer:
        `Yes — we cover ${suburbName} and the entire surrounding region. We also service all Cairns suburbs, Far North Queensland, and interstate routes. Call 1300 959 498 if you have any questions about your specific location.`,
    },
    {
...
// PAGE
// ─────────────────────────────────────────────────────────────────────────────
export default async function RemovalistsSuburbPage({
  params,
}: {
  params: Promise<{ suburb: string }>;
}) {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                text: "Trusted by hundreds of families and businesses across Cairns",
              },
              {
              ...
              },
              {
                ...
                text: "Two depots — Cairns City and Archerfield, Brisbane",
              },
            ].map((badge) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 text-base max-w-2xl mx-auto">
              ...
              Our locally-based team knows the streets and access challenges in this part of Cairns.
