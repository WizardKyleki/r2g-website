...
function getFaqItems(suburbName: string) {
  return [
    ...
    },
    {
      ...
      answer:
        `Yes — we cover ${suburbName} and the entire surrounding Sunshine Coast region. We also service all Sunshine Coast suburbs, South-East Queensland, and interstate routes. Call 1300 959 498 if you have any questions about your specific location.`,
    },
    {
