...
const pageConfig = {
  ...
  locationFull: "Sunshine Coast, QLD",
  h1: "Removalists Sunshine Coast",
  suburb: "Maroochydore",
  postcode: "4558",
...
const businessSchema = {
  ...
  description:
    `Fully insured local and interstate removalists on the Sunshine Coast. ${RATING_DISPLAY}. 10+ years experience.`,
...
const faqItems = [
  ...
  {
    question: "Do you move pianos and heavy items on the Sunshine Coast?",
    answer:
      "Yes. Our team is trained and equipped to move heavy and awkward items including pianos, pool tables, large fridges, gym equipment and safes. We handle moves across Maroochydore, Buderim, Nambour and all Sunshine Coast suburbs. Let us know about specialty items when requesting your quote.",
  },
  {
    question: "Do you cover all Sunshine Coast suburbs?",
    answer:
      "Yes — we cover the entire Sunshine Coast region including Maroochydore, Caloundra, Noosa Heads, Mooloolaba, Buderim, Nambour, Coolum Beach, Kawana Waters, Sippy Downs, Peregian Springs, Palmwoods, Beerwah, Landsborough, Maleny, Glass House Mountains, and all surrounding areas.",
  },
  {
    question: "Can I book a last-minute removal on the Sunshine Coast?",
    answer:
      "We do our best to accommodate last-minute bookings on the Sunshine Coast, subject to availability. Call us on 1300 959 498 to check our earliest available date. For guaranteed availability we recommend booking at least 1-2 weeks in advance.",
  },
  {
    question: "Do you offer packing services on the Sunshine Coast?",
    answer:
      "Yes — we offer full and partial packing services for Sunshine Coast moves. Our team can pack your entire home using quality materials, or just pack specific fragile items like TVs, artwork, glassware and mirrors. Ask about packing when you request your quote.",
  },
  {
    question: "How far in advance should I book my Sunshine Coast move?",
    answer:
      "We recommend booking at least 2 weeks in advance for local Sunshine Coast moves, and 3-4 weeks during peak periods like November through January. That said, we always try to accommodate last-minute bookings — call 1300 959 498 to check availability.",
  },
  {
    question: "Do you provide storage on the Sunshine Coast?",
    answer:
      "Yes — R2G offers secure short and long-term storage for Sunshine Coast customers. This is ideal if there is a gap between your move-out and move-in dates. Contact us to discuss storage options when booking your move.",
  },
  {
    question: "Are your removalists on the Sunshine Coast fully insured?",
    answer:
      "Absolutely. Every R2G move on the Sunshine Coast is covered by comprehensive public liability insurance and goods-in-transit insurance. Your belongings are protected from the moment we load the truck to the moment we unload at your new home.",
  },
  {
    question: "Can you move me interstate from the Sunshine Coast?",
    answer:
      "Yes — we offer interstate removals from the Sunshine Coast to Brisbane, Sydney, Melbourne, Cairns and all major Australian cities. We provide fixed-price interstate quotes based on volume and distance. Contact us for a tailored interstate quote.",
  },
  {
    question: "What areas near the Sunshine Coast do you service?",
    answer:
      "We service the entire Sunshine Coast region including Maroochydore, Caloundra, Noosa Heads, Mooloolaba, Buderim, Nambour, Coolum Beach, Kawana Waters, Sippy Downs, Peregian Springs, Palmwoods, Beerwah, Landsborough, Maleny, Glass House Mountains, Bli Bli, Yandina, and all surrounding suburbs. We also cover Brisbane and the broader South-East Queensland region.",
  },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Removalists Sunshine Coast",
      item: "https://www.r2g.com.au/removalists-sunshine-coast",
    },
  ],
};
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "moving company sunshine coast",
    "house removals sunshine coast",
    "local removalists sunshine coast",
...
// PAGE
// ─────────────────────────────────────────────────────────────────────────────
export default function RemovalistsSunshineCoastPage() {
  return (
    <>
      {/* JSON-LD */}
      ...
      <section className="bg-[#1A1A1A] pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
            <span className="text-[#F5C400]">Removalists Sunshine Coast</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                {heroSubtitle("Sunshine Coast", "South-East Queensland")}
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Trusted by hundreds of families and businesses across the Sunshine Coast",
              },
            ].map((badge) => (
              <div
                key={badge.title}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-[#1A1A1A] mb-6">
                Sunshine Coast&apos;s Local Moving Specialists
              </h2>
              ...
              <div className="relative h-72 sm:h-80 rounded-2xl overflow-hidden shadow-lg mb-8">
                <Image
                  ...
                  alt="R2G removalists truck on the Sunshine Coast"
                  title="R2G Removalists Sunshine Coast - Professional Local Moving Team"
                  fill
              ...
              <div className="space-y-5 text-gray-600 leading-relaxed">
                <p>
                  When it comes to moving on the Sunshine Coast, local knowledge makes all the difference.
                  R2G Transport &amp; Storage operates from our depot in Archerfield, giving us the reach
                  to cover all Sunshine Coast suburbs from Noosa Heads in the north to Glass House Mountains
                  in the south, and west to Maleny in the hinterland.
                </p>
                <p>
                  Whether you&apos;re moving from a beachside apartment in Mooloolaba to a family home in Buderim,
                  relocating from Caloundra to Nambour, or simply moving a few streets
                  over in Maroochydore — our experienced team of Sunshine Coast removalists handles every move with the same
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-[#1A1A1A] mb-2">
              Sunshine Coast Removalist Pricing for Local Moves
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-12 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-[#1A1A1A] mb-2">
                How Your Sunshine Coast Move Works
              </h2>
                ...
                {[
                  {
                    ...
                    text: "Contact us online or call 1300 959 498. Tell us about your Sunshine Coast move — suburbs, home size, and preferred date. We'll provide a clear, upfront quote with no hidden fees.",
                  },
                  {
                    number: "02",
                    title: "We Pack & Load",
                  ...
                  },
                  {
                    ...
                    text: "We transport your belongings safely to your new Sunshine Coast location and unload everything exactly where you want it. We won't leave until you're completely happy — it's that simple.",
                  },
                ].map((step) => (
            ...
            <div className="relative h-[420px] lg:h-[540px] rounded-2xl overflow-hidden shadow-lg">
              <Image
                ...
                alt="R2G removalist team serving the Sunshine Coast"
                title="R2G Professional Packing Service Sunshine Coast"
                fill
                className="object-cover"
                loading="lazy"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-3">
              Sunshine Coast Suburbs We Service
            </h2>
            <p className="text-gray-400 text-base max-w-2xl mx-auto">
              We cover the entire Sunshine Coast region — from Noosa Heads in the north to Glass House Mountains
              in the south, and west to Maleny and Kenilworth in the hinterland.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-14">
            {["Sunshine Coast South", "Sunshine Coast Central", "Sunshine Coast North", "Noosa", "Noosa Hinterland", "Sunshine Coast Hinterland"].map((region) => {
              const suburbs = sunshineCoastSuburbs
                ...
                <div key={region}>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {suburbs.map((suburb) => (
                      <Link
                        key={suburb.slug}
                        href={`/removalists-sunshine-coast/${suburb.slug}`}
          ...
          <div className="border-t border-white/10 pt-12 mt-10">
            <h3 className="text-2xl font-black text-white text-center mb-8">
              Tips for a Smooth Sunshine Coast Move
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  heading: "Book early during school holidays and peak season.",
                  text: "The Sunshine Coast is a popular relocation destination, and removal services get very busy from November through January and during school holidays. Aim to book at least 3-4 weeks in advance to secure your preferred date.",
                },
                {
                  heading: "Plan for hinterland access challenges.",
                  text: "If you're moving to or from hinterland suburbs like Maleny, Montville, or Mapleton, steep driveways and narrow mountain roads can add complexity. Let us know upfront so we can bring the right-sized truck and plan access routes accordingly.",
                },
                {
                  heading: "Prepare for the subtropical climate.",
                  text: "The Sunshine Coast's subtropical summer (November-March) brings afternoon storms and high humidity. Our team takes extra precautions to protect your belongings in wet weather — keep an eye on forecasts and communicate with us if conditions are extreme.",
                },
                {
                  heading: "Coordinate apartment and body corporate access.",
                  text: "Many Sunshine Coast beachside suburbs like Mooloolaba, Caloundra and Maroochydore have apartment buildings with body corporate rules for moving. Book your lift and loading dock access well in advance, and let us know about any building-specific requirements.",
                },
              ].map((tip) => (
      ...
      {/* ── SECTION 8: FAQ ──────────────────────────────────────────────────── */}
      <FAQ items={faqItems} heading="Sunshine Coast Removals FAQ" />
      ...
      <section className="relative overflow-hidden bg-[#F5C400] py-20">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-black text-[#1A1A1A] mb-4">
            Ready to Move on the Sunshine Coast?
          </h2>
