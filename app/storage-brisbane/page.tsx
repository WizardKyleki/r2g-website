...
import { PHONE, PHONE_HREF, BRISBANE_ADDRESS, CAIRNS_ADDRESS } from "@/lib/constants";
...
const faqs = [
  {
    question: "How secure is your Brisbane storage facility?",
    answer:
      "Our Brisbane storage facility at Archerfield is fully fenced, monitored 24/7 by CCTV, and secured with electronic access control. Only authorised persons can access the site, and all units are individually locked.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. We specialise in combined move-and-store packages. We pick up your items from your current home, store them safely in Brisbane, and deliver them to your new address when you're ready. This is ideal for settlement delays and rental overlaps.",
  },
  {
  ...
  {
    question: "Do you service all Brisbane suburbs?",
    answer:
      "Yes, our combined move-and-store service covers all Brisbane suburbs as well as the Gold Coast, Sunshine Coast, Ipswich, Logan, and Moreton Bay regions. We also handle interstate moves with storage at either end.",
  },
];
...
const storageSchema = {
  ...
  "@type": "Service",
  name: "Storage Brisbane",
  description:
    "Secure, clean storage facilities in Brisbane. Flexible short and long-term solutions for residential and commercial customers.",
  provider: {
    "@type": "MovingCompany",
...
export default function StorageBrisbanePage() {
  return (
    <>
      <script
      ...
      <PageHero
        ...
        subtitle="Secure, clean, and flexible storage solutions in Brisbane — short-term, long-term, or combined with your removal service."
        breadcrumbs={[{ label: "Home", href: "/" }, { label: "Storage Brisbane" }]}
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <h2 className="text-3xl font-black text-[#1A1A1A] mb-6">
                Brisbane Storage You Can Actually Rely On
              </h2>
              <div className="relative h-72 rounded-2xl overflow-hidden mb-8">
                <Image
                  src="/images/blog-storage.webp"
                  alt="R2G secure storage facility in Brisbane with clean dry monitored units - R2G Removalists Brisbane Storage"
                  title="R2G secure storage facility in Brisbane with clean dry monitored units"
                  fill
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Whether you need somewhere to store your belongings between moves, during a renovation, while waiting for settlement, or simply to free up space at home or work — R2G Transport &amp; Storage has a secure, clean, and affordable storage solution in Brisbane ready for you.
                </p>
                <p>
                  Our Brisbane storage facility at Archerfield is monitored 24/7 with CCTV and secured with electronic access control. Units are clean, dry, and maintained to a high standard. We offer flexible weekly and monthly lease terms with no lock-in contracts, so you&apos;re never paying for more time than you need.
                </p>
                <p>
                  One of our most popular options is our combined moving and storage service. Our team picks up your items from your Brisbane home, carefully loads them, stores them in our facility, and then delivers everything to your new address once you&apos;re ready. It&apos;s the seamless solution for settlement delays, interstate moves, or staggered relocations.
                </p>
                <p>
              ...
              {/* Who uses it */}
              <h3 className="text-xl font-bold text-[#1A1A1A] mb-5">Who Uses Our Brisbane Storage?</h3>
              <div className="space-y-4 text-gray-600 leading-relaxed mb-8">
                ...
                <p>
                  <strong className="text-[#1A1A1A]">People moving interstate</strong> — Moving from Brisbane to Cairns, Sydney, or Melbourne? Store your belongings with us while you get settled, then have them delivered when you&apos;re ready. No rush, no stress.
                </p>
                <p>
            ...
            <div>
              <div className="bg-[#1A1A1A] rounded-2xl p-8 sticky top-28">
                ...
                <p className="text-gray-400 text-sm mb-6">Tell us what you need to store and we&apos;ll give you a fast, free quote for Brisbane storage.</p>
                <Link
                  href="/quote"
      ...
      <FAQ items={faqs} heading="Brisbane Storage FAQ" />
      ...
      <section className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { title: "Packing Services Brisbane", desc: "Professional packing for your Brisbane move.", href: "/packing-services-brisbane" },
      ...
      <CTABanner
        heading="Need Storage in Brisbane?"
