...
const coreSuburbs: SunshineCoastSuburb[] = [
  {
    ...
    phone: "1300 959 498",
    metaTitle: "Removalists Maroochydore | Reliable & Affordable",
    metaDescription:
      "Trusted removalists in Maroochydore with 10+ years experience. Reliable, affordable & fully insured — no hidden fees. Get a free quote today.",
    reviews: [
      {
