...
const coreSuburbs: TownsvilleSuburb[] = [
  {
    ...
    state: "QLD",
    distanceFromCBD: "0km â€” Townsville CBD",
    postcode: "4810",
    latitude: -19.2577,
    longitude: 146.8082,
    uniquePara1:
      "Townsville City is the commercial and administrative hub of North Queensland, with a growing residential population drawn by waterfront living along the Breakwater and the revamped CBD precinct. Defence families posted to Lavarack Barracks often land their first rental in the city centre before figuring out the lay of the land. JCU students grab units on Stanley and Sturt Streets for the walk to campus, and young professionals love being close to the restaurants and bars along Flinders Street East. The city has changed a lot over the past decade â€” old commercial buildings converted into apartments, new mixed-use developments along the waterfront, and a solid community feel that surprises most newcomers expecting just a big country town.",
    uniquePara2:
      "Housing in the CBD is mostly apartments and refurbished units â€” everything from small one-bed studios above shops on Flinders Street to modern two and three-bedroom apartments in the waterfront complexes near the Strand end. There are still a handful of older timber cottages on the backstreets around Denham and Walker Streets, but they are getting rarer. Moves here tend to be smaller â€” one or two-bedroom loads â€” but the challenge is always access. Lifts, narrow corridors, basement car parks. We bring tall trolleys and lift protection on every CBD job because most buildings require it. The occasional large house move from one of the remaining cottages keeps things interesting.",
    uniquePara3:
    ...
    localFaqs: [
      ...
      },
      {
        ...
        answer:
          "Early morning is best â€” 6:30am starts let us load before the heat gets brutal and before Flinders Street traffic builds up. During summer months, an early start means the heavy lifting is done before it hits 35 degrees. We factor in water breaks and shade rest for our crew on hot days.",
      },
      {
    ...
    reviews: [
      ...
      },
      {
        ...
        name: "Josh R.",
        location: "Townsville City â†’ Aitkenvale",
        date: "August 2024",
      },
    ],
    tips: [
      {
        ...
        text: "Most CBD apartment buildings only allow removalist access during specific hours and require a lift booking. Confirm your building's requirements as soon as you set a moving date â€” popular time slots fill up fast, especially at the end of the month.",
      },
      {
  ...
  },
  {
    ...
    moveDay:
      "South Townsville jobs are some of our favourites â€” short distances, interesting old houses and usually a decent coffee from Palmer Street to kick off the morning. We had a job last month moving a couple from a renovated cottage on Hugh Street to a newer townhouse in Annandale. Got there at 7am and parked the medium truck on the street right out front â€” no dramas with access, which is not always the case down here.\n\nThe cottage was a classic two-bedroom Queenslander renovation â€” polished timber floors, original doorways that were about 50mm narrower than modern standard. The king bed frame had to come apart to get through the bedroom door, and we removed the legs from their leather couch to clear the front hallway. All up the load was not huge but it was fiddly â€” lots of framed artwork, a vintage bar cart, wine collection in timber crates, that kind of thing. We wrapped everything individually.\n\nDrove out via Hubert Street to avoid Palmer Street, hit Stuart Drive and were at the Annandale townhouse in ten minutes. The new place had a double garage and wide internal doors, so unloading was quick. Beds reassembled, couch legs back on, artwork leaned against the walls where they wanted to hang them later. Done by 11:30am. The bloke reckoned it was the least stressful move he had ever done, which is exactly what we aim for.",
    localFaqs: [
      {
    ...
    serviceSummary:
      "South Townsville moves are all about working with the character of these old streets â€” narrow frontages, original-width doorways and compact courtyard yards. We run medium trucks that fit the tight streets, carry toolkits for furniture disassembly through narrow hallways, and use protective runners on the polished timber floors that most renovated cottages have. During the wet season we keep a close eye on Ross Creek levels and reschedule when needed rather than risk your belongings.",
    reviews: [
      {
        text: "R2G moved us from a cottage on Hubert Street to Kirwan. They knew exactly how to handle the narrow hallways and old doorways â€” took the bed apart, wrapped our artwork individually and were done before lunch. Legends.",
        name: "Chris M.",
      ...
      },
      {
        ...
        name: "Peter H.",
        location: "Mundingburra â†’ South Townsville",
        date: "July 2024",
      },
    ],
    tips: [
      ...
      },
      {
        ...
        text: "The original workers cottages in South Townsville have doorways as narrow as 720mm â€” tighter than modern standard. Measure your bedroom doors and hallways so we can plan disassembly for king beds, large sofas or wide dressers before moving day.",
      },
      {
      ...
      },
      {
        ...
        text: "Parts of South Townsville near Ross Creek are flood-mapped. If you are moving into the area, sort your insurance out before settlement and keep valuable items elevated off the floor during wet season â€” just in case.",
      },
    ],
  },
  {
    ...
    longitude: 146.79,
    uniquePara1:
      "North Ward is premium Townsville real estate â€” tree-lined streets, beautiful old Queenslanders and direct access to The Strand foreshore. Families, retirees and professionals compete for homes here, and the turnover is steady because everyone wants a piece of it. Gregory Street is the main spine, with cafes and shops that give the suburb a village atmosphere. The mix of long-term residents and newcomers keeps the community lively. Walk to The Strand for a morning swim at the rock pool, grab breakfast at one of the Gregory Street cafes, and you start to understand why people pay the premium. Defence officers on posting to Lavarack often rent in North Ward for the lifestyle, and JCU academics settle here for the character homes and proximity to campus.",
    uniquePara2:
      "Housing runs the full spectrum â€” grand old Queenslanders on The Strand and Howitt Street with sweeping verandahs and high ceilings, solid post-war brick homes on the mid-streets, and modern apartments scattered through the mix. The Queenslanders are the signature, though â€” raised on stumps, timber floors, wide hallways and those classic deep verandahs. Moves here often involve large, heavy furniture in two-storey timber homes with steep external staircases. We bring stair equipment and extra blankets on every North Ward job because the Queenslanders demand it. The occasional apartment move in the newer blocks along The Strand is a nice change of pace.",
    uniquePara3:
      "The Strand gets packed on weekends and public holidays, so Saturday moves in the beachfront streets need an early start. Street parking is usually fine on the residential streets off Gregory, but The Strand-facing properties can be tricky â€” especially during Townsville events like the Supercars. Our trucks approach via Eyre Street or Paxton Street to avoid The Strand congestion. The Gregory Street strip itself has timed parking that is not ideal for a truck sitting there all morning, so we position on side streets. Road surfaces are good, most driveways are solid, and the suburb is flat to gently sloping â€” no major gradient challenges like Castle Hill next door.",
    ...
    reviews: [
      ...
      },
      {
        ...
        name: "Lisa G.",
        location: "North Ward â†’ Annandale",
        date: "December 2024",
      },
      {
    ...
    tips: [
      {
        ...
        text: "Most North Ward Queenslanders have external timber staircases with one or two landings. Measure the width and note any tight turns â€” if your fridge or sofa will not clear the front stairs, we can often use the rear stairs or rig items over the verandah railing with proper equipment.",
      },
      {
  ...
  },
  {
    ...
    moveDay:
      "Castle Hill jobs earn their money. We had one last month on Stagpole Street â€” a split-level brick home about two thirds of the way up the hill with 28 steps from the driveway to the front door and another internal staircase between the living level and the bedrooms. Three-bedroom place with a full garage underneath packed with camping gear and tools.\n\nWe brought four blokes and the medium truck. The driver assessed the street before reversing up to the driveway â€” tight, but doable. We set up a relay system: two blokes at the top wrapping and carrying items to the landing, two at the bottom receiving and loading the truck. The fridge was the monster â€” a 680-litre side-by-side that took all four of us on a stair trolley down those 28 steps. We strap it to the trolley, one bloke on each side guiding, one at the bottom braking, one at the top feeding it down. Slow and controlled.\n\nThe views from the lounge room were unreal â€” you could see all the way to Magnetic Island. But we were not there for the views. By mid-morning the house was cleared and we drove back down Stanley Street to the new place in Aitkenvale. Flat block, double garage, wide doors â€” unloaded in half the time it took to load. Total job was about six hours, which is right for a Castle Hill three-bedder with a full garage. The owners knew it would be a stair job and had budgeted for the extra crew member, which made the whole thing smoother.",
    localFaqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Castle Hill moves generally take longer due to stair carries and the relay system we use to move items safely up or down steep terrain. We quote based on the specific property â€” number of stairs, driveway gradient and access conditions all factor in. We are upfront about this during the quoting process.",
      },
      {
    ...
    reviews: [
      {
        text: "Moved from a split-level on Stagpole Street â€” 30-something steps to the front door. R2G brought four blokes, had a stair trolley and a relay system running like clockwork. The fridge coming down those steps was impressive. No damage to anything.",
        name: "Tony B.",
      ...
      {
        text: "The R2G team moved us out of Castle Hill before cyclone season. They navigated the steep driveway and narrow street perfectly with the medium truck. Four hours for a two-bedroom â€” fair price given the stair work involved.",
        name: "Greg D.",
        location: "Castle Hill â†’ Kirwan",
        date: "September 2024",
      },
    ],
    tips: [
      ...
      },
      {
        ...
        text: "Most Castle Hill moves need an additional crew member for stair carries â€” especially if your property has 20-plus steps. This adds to the hourly rate but significantly speeds up the job and reduces the risk of damage to your belongings and the property.",
      },
    ],
  },
  {
    ...
    moveDay:
      "Belgian Gardens jobs often start with a quick drive past The Strand on the way in â€” not a bad office view. Last fortnight we moved a retired couple from a raised Queenslander on Bundock Street to a ground-level unit in Pimlico. They had been in the house for 22 years and accumulated accordingly.\n\nWe arrived at 6:30am with three blokes and a large truck â€” the street was wide and flat on the Strand side, so parking was no issue. The Queenslander was raised about 1.5 metres with a solid timber staircase and a wide front verandah. Inside, the hallway was generous â€” original proportions â€” so the big furniture moved through without disassembly. The main challenge was the sheer volume: four bedrooms fully furnished, a study full of books, a workshop under the house packed with tools, and a garden shed that could have stocked a hardware store.\n\nWe loaded room by room, heaviest items first â€” the workshop tools and book boxes went in at the back of the truck, then bedroom furniture, then living areas. The crew worked in pairs, one wrapping and one carrying, with the third bloke organising the truck. By 11am the house was empty and we drove across to Pimlico. The unit was much smaller, so about half the load went to our storage facility. We unloaded the essentials into the unit, labelled the storage items clearly, and had everything sorted by 2pm. Seven hours including the storage run â€” a solid day's work for a house that size.",
    localFaqs: [
      {
        question: "Is Belgian Gardens good access for removal trucks?",
        answer:
          "The flatter eastern streets near The Strand are excellent for truck access â€” wide, well-maintained and easy to park. The western streets climbing toward Castle Hill are steeper and narrower, and some cul-de-sacs require careful reversing. We assess your specific street during the quoting process.",
      },
      {
    ...
    reviews: [
      ...
      {
        text: "Moved into Belgian Gardens from Kirwan â€” the R2G crew knew exactly where to park on our street and had the truck positioned before we finished our morning coffee. Quick, careful and good value. Happy to recommend.",
        name: "Ben C.",
        location: "Belgian Gardens",
        date: "October 2024",
      },
      {
        text: "We had a tight move from a raised house on the Castle Hill side of Belgian Gardens. Steep driveway and external stairs. R2G brought a stair trolley and extra crew without being asked â€” they clearly knew the area. No damage, no stress.",
        name: "Priya N.",
        location: "Belgian Gardens",
        date: "July 2024",
      },
    ...
    tips: [
      {
        ...
        text: "Belgian Gardens is known for its mature mango and poinciana trees. If low branches hang over your driveway or street frontage, trimming them before the move lets our truck park closer and saves carry time â€” which saves you money.",
      },
      {
      ...
      },
      {
        ...
        text: "Events on The Strand can affect traffic and parking on the eastern Belgian Gardens streets. Check the local events calendar before locking in your date â€” a Strand event weekend can add 30 minutes of access hassle that a midweek move avoids entirely.",
      },
    ],
  },
  {
    ...
    longitude: 146.795,
    uniquePara1:
      "Railway Estate is old Townsville â€” a working-class suburb with roots going back to the rail yards that gave it its name. These days it is gentrifying slowly, with young buyers picking up the original timber cottages and doing them up while long-term residents hold onto their family homes. The streets are laid out on a tight grid with small blocks and narrow frontages, which gives the suburb a dense, neighbourly feel. It sits between Ross Creek and the rail corridor, just a short walk south of the CBD. The pubs and shops on Ingham Road anchor the community, and the proximity to South Townsville and the city means residents are never far from anything. Flooding is a real concern here â€” Railway Estate copped it during the 2019 monsoon event, and that history shapes the suburb to this day.",
    uniquePara2:
      "Almost every home in Railway Estate is a small timber cottage â€” weatherboard or fibro, raised on low stumps, with tin roofs and small front verandahs. They are charming but compact. Two or three bedrooms is the standard, and internal spaces are tight. Hallways are narrow, doorways are original width, and rooms are modest in size. Renovated cottages open up the living areas but rarely change the access points, so getting furniture in and out requires the same careful manoeuvring regardless of how modern the kitchen looks. Storage sheds out the back are common, and most yards have a Hills Hoist and not much else. Moves are typically small â€” one to two truckloads â€” but the tight spaces mean they take longer than you would expect for the volume.",
    uniquePara3:
      "The grid layout of Railway Estate means straight streets with good truck access â€” no winding cul-de-sacs or steep hills. The challenge is width. Street parking on both sides can reduce the available road to a single lane, and some of the older streets do not have kerbing. We run medium trucks as standard for Railway Estate and park on the same side as the property to minimise carry distance. The railway corridor along the western edge generates occasional noise but does not affect access. During heavy rain, the low-lying sections near Ross Creek can flood rapidly â€” we monitor forecasts closely during the wet season and reschedule when creek levels are rising.",
    ...
    moveDay:
      "Railway Estate moves are bread and butter for us â€” small houses, tight spaces, and a crew that knows how to work efficiently in compact cottages. We did a job on Perkins Street recently, moving a young couple from a renovated two-bedroom cottage to a house in Cranbrook. Classic Railway Estate property â€” fibro on stumps, narrow front steps, small rooms off a skinny hallway.\n\nGot there at 7am, parked the medium truck right out front on the street. No issues with access â€” the grid streets are straight and the neighbours were not out yet. Started with the bedroom at the back and worked forward. The queen bed frame had to come apart to clear the hallway â€” we knew it would from experience. The couch went out sideways through the front door with about 20mm clearance on each side. Everything else was standard â€” boxes, a small dining table, the usual kitchen stuff.\n\nThe washing machine was under the house in the laundry â€” low clearance, had to duck-walk it out on a trolley. The yard shed had a few tools, a pushbike and some camping gear. All up it was a light load by weight but slow going because of the tight access.\n\nWe drove out to Cranbrook via Ingham Road â€” about 15 minutes. The new house was a modern three-bedroom with wide hallways and a double garage. Night and day compared to the cottage. Unloaded in less than an hour. Total time was three and a half hours. The couple said it was the smoothest move they had been through, and they had moved three times in five years.",
    localFaqs: [
      {
    ...
    reviews: [
      ...
      },
      {
        ...
        name: "Nicole F.",
        location: "Railway Estate â†’ Mundingburra",
        date: "February 2024",
      },
    ],
    tips: [
  ...
  },
  {
    ...
    uniquePara2:
      "Housing in West End is predominantly older timber cottages and fibro homes â€” similar stock to Railway Estate but with slightly larger blocks on some streets. You will find a few modern infill builds where old homes have been knocked down, but the character of the suburb is firmly in the pre-1980 era. Most homes are two to three bedrooms with small yards and carports rather than garages. The cottages on the higher ground closer to Castle Hill tend to be raised on taller stumps with under-house storage, while the flatter sections have low-set homes. Moves are typically modest in size â€” a standard two or three-bedroom household without the oversized furniture you see in newer suburbs.",
    uniquePara3:
      "West End streets are quiet and access is generally straightforward for a medium truck. The suburb is small enough that there are only a handful of main routes in and out â€” most moves use Ingham Road or come through from Railway Estate via the cross streets. The western edge near Castle Hill rises gently, but nothing like the steep grades on the hill itself. Street parking is rarely an issue given the low traffic volumes. The main access consideration is the under-house areas on raised cottages â€” low-clearance stumps mean we sometimes need to get creative extracting washing machines and stored items from tight spaces. During the wet season, the lower sections can hold water after heavy rain, but West End fares better than Railway Estate for drainage overall.",
    ...
    metaDescription:
      "West End Townsville removalists. Local knowledge, honest pricing, fully insured. Cottages, Queenslanders and units â€” we handle them all. Free quote.",
    moveDay:
      "West End is a quiet suburb to work in, which makes for efficient moves. We had a job recently on a back street near the Castle Hill end â€” a young nurse moving from a two-bedroom timber cottage to a unit closer to the hospital in Douglas. She had been renting the place for two years and had a sensible amount of stuff â€” nothing oversized.\n\nWe arrived at 7am with two blokes and the small truck. The cottage was raised on low stumps with a narrow front staircase â€” five steps, nothing dramatic. The rooms were compact but the hallway had been opened up in a previous renovation, so the couch and bed base came out without disassembly. The bedroom at the back had a built-in wardrobe, so it was mostly boxes and a bedside table. Kitchen took about 20 minutes to wrap and box the fragile items she had not packed yet.\n\nUnder the house was the usual â€” a washing machine wedged into a low-clearance laundry space, a couple of bikes, and some storage tubs. We duck-walked the washer out on a trolley and loaded the rest by hand. The whole house was on the truck by 9am.\n\nDouglas was about a ten-minute drive. The new unit was ground floor with a carport right next to the front door â€” easiest unload we had done all week. Washing machine in, beds set up, boxes stacked in the right rooms. Done by 10:30am. She texted later saying she was already unpacked and on the couch by lunchtime. That is what a clean, well-organised move looks like.",
    localFaqs: [
      {
      ...
      },
      {
        ...
        answer:
          "All the time. West End to Douglas or the Townsville Hospital area is one of our most common short-distance routes. Medical professionals on rotating shifts appreciate the quick, efficient service â€” we can have a one or two-bedroom move done in a morning.",
      },
      {
    ...
    serviceSummary:
      "West End moves are typically clean and efficient â€” modest-sized homes on quiet streets with reasonable truck access. Our crew handles the older cottage quirks â€” narrow doorways, low-clearance under-house laundries, compact rooms â€” as part of the daily routine. For the raised homes near the Castle Hill end, we bring stair trolleys and extra padding. Short-distance moves to Douglas, Pimlico and the hospital precinct are a speciality, and we can usually have a two-bedroom West End home loaded, delivered and unpacked in a single morning.",
    reviews: [
      {
        text: "R2G moved me from a cottage in West End to a unit in Douglas. Two blokes, small truck, done by mid-morning. Exactly what I needed â€” no fuss, no damage, fair price. Will definitely use them again when I move next year.",
        name: "Hannah L.",
        location: "West End",
        date: "January 2025",
      },
      {
        ...
        name: "Darren T.",
        location: "West End â†’ Kirwan",
        date: "September 2024",
      },
      {
        text: "Hired R2G for a quick move within West End â€” just two streets over. They still came with full gear, wrapped everything properly and treated it like any other job. No shortcuts. Impressed with the professionalism.",
        name: "Leah M.",
        location: "West End",
        date: "June 2024",
      },
    ...
    tips: [
      ...
      },
      {
        ...
        text: "West End cottage kitchens are compact but people accumulate a lot of glassware and crockery. Packing your own kitchen items the night before saves time on moving day â€” we provide packing materials if you need them, just ask when you book.",
      },
    ],
  },
  {
    ...
    longitude: 146.775,
    uniquePara1:
      "Rowes Bay is a small, quiet pocket at the northern tip of The Strand, where the foreshore curves around toward Pallarenda and the mangroves of the bay. It is tucked away enough that most Townsville locals drive through without realising it is there. The residential streets are shaded by mature trees, the blocks are generous, and the pace of life is noticeably slower than neighbouring North Ward. Families and retirees make up most of the population â€” people who chose Rowes Bay specifically because it is not busy. The Rowes Bay Sustainability Centre is a local landmark, and the walking path along the bay is popular with morning walkers and cyclists. Military families stationed at Lavarack sometimes land here for the quiet lifestyle and easy access to the barracks via Stuart Drive.",
    uniquePara2:
      "Housing in Rowes Bay is mostly established family homes â€” a blend of 1960s and 70s brick-and-tile, some raised timber homes, and a handful of larger modern builds on the waterfront side. There is very little medium or high-density development, which keeps the suburban character intact. Blocks are larger than the inner suburbs, and most homes have garages or at least covered carports. Moves here tend to be full family households â€” three to four bedrooms with outdoor furniture, garden equipment, bikes and the accumulated belongings that come with settled suburban living. The occasional waterfront property move involves higher-value items and requires extra care.",
    uniquePara3:
      "Rowes Bay has excellent truck access. The streets are wide and well-maintained with good turning circles at the end of cul-de-sacs. There is no through traffic to speak of â€” the suburb dead-ends at the bay, so our truck is usually the only large vehicle on the street. The approach from The Strand via the roundabout at the northern end is straightforward, and there is an alternative access from Pallarenda Road. Driveways are typically wide enough to back the truck right up to the garage, which speeds up loading significantly. The only seasonal consideration is stinger season â€” the foreshore paths and bay beach attract box jellyfish from November to May, which does not affect the move directly but is worth knowing if you are bringing kids along on moving day.",
    ...
    moveDay:
      "Rowes Bay is one of the easier suburbs to work in â€” wide streets, big driveways and no traffic to deal with. We moved a family of four from a large four-bedroom brick home near the waterfront to a new build in the northern beaches. The house had a double garage packed with gear, a garden shed, a trampoline in the backyard and enough furniture to fill every room.\n\nWe arrived at 7am with three blokes and a large truck. Backed straight into the driveway â€” plenty of room to position the tailgate right at the garage door. Started loading the garage first while the family finished their last-minute packing inside. The garage alone took an hour â€” tools, bikes, camping gear, fishing rods, storage tubs stacked to the ceiling.\n\nInside the house was well organised. The family had packed their own boxes and labelled everything by room, which made our job significantly easier. We wrapped the furniture â€” leather couch, dining table, beds â€” and loaded room by room from the back of the house forward. The kitchen crockery and glassware went into dish packs with butchers paper between each piece.\n\nThe trampoline was the fun bit â€” dismantled it in the backyard, carried the frame and mat out through the side gate, and slotted the pieces along the inside wall of the truck. By 11am the house was empty and cleaned out. We drove up to the new place â€” about 25 minutes on the highway â€” and unloaded into a house with even wider doors and a three-car garage. Everything placed, beds assembled, trampoline back together in the new yard. Done by 2:30pm. A big move but a clean run with no hiccups.",
    localFaqs: [
      {
    ...
    reviews: [
      ...
      {
        text: "We downsized from a large home in Rowes Bay to a unit in North Ward. R2G took the essentials to the new place and the rest to storage â€” all in one trip. The crew were efficient and friendly. Great experience.",
        name: "Barbara P.",
        location: "Rowes Bay â†’ North Ward",
        date: "December 2024",
      },
      {
    ...
    tips: [
      {
        ...
        text: "Most Rowes Bay homes have wide driveways that fit a removal truck easily. Clear your garage and driveway the night before so we can back the truck right up to the house â€” this saves time on every trip between the truck and your front door.",
      },
      {
        heading: "Dismantle outdoor items before moving day if you can.",
        text: "Trampolines, swing sets and large outdoor furniture take time to disassemble. If you can break them down before we arrive, it saves an hour or more. If not, no dramas â€” our crew carries the tools and knows how to dismantle common brands.",
      },
      {
        heading: "Label boxes by room for the new place.",
        text: "Rowes Bay moves often involve large, well-established households. Labelling every box with the destination room name means our crew can place them exactly where you want them at the new house â€” no double-handling, no confusion.",
      },
      {
        heading: "Book a morning move to beat the heat.",
        text: "Rowes Bay is exposed to full tropical sun with limited shade on most streets. A 7am start lets us get the heavy loading done in the cooler hours. On hot days, our crew takes water breaks every 30 minutes â€” starting early keeps the total job time down.",
      },
    ],
  },
  {
    ...
    longitude: 146.76,
    uniquePara1:
      "Pallarenda is the end of the road â€” literally. The suburb sits at the tip of the peninsula north of Rowes Bay, with views across Cleveland Bay to Magnetic Island and nothing but mangroves and foreshore beyond the last house. It is a small, tight-knit community that feels a world away from the rest of Townsville despite being only seven kilometres from the CBD. The houses are mostly older, many built by families who bought cheap blocks decades ago when no one else wanted to live this far out. These days Pallarenda attracts a mix of retirees, nature lovers and families who want beachfront living without the price tag of North Ward. The Pallarenda Environmental Park is a local treasure, and the boat ramp at the end of the road is the launching point for fishing trips and Magnetic Island day trips.",
    uniquePara2:
      "The housing stock is eclectic â€” everything from basic fibro beach shacks to renovated family homes and the occasional architecturally designed build taking advantage of the water views. Most homes are single storey, some raised on stumps to catch the breeze and reduce flood risk. Blocks vary in size, with the older properties on generous parcels and newer subdivisions more compact. Moves in Pallarenda tend to be relaxed affairs â€” smaller households, manageable volumes, and owners who are not in a rush because nobody moves to the end of the road unless they are settling in for the long haul. The salty air does a number on outdoor furniture and metal items, so we wrap and protect coastal gear with extra care.",
    uniquePara3:
      "There is one road in and one road out â€” Pallarenda Road. This means no alternative route if there is a tree down or road work, so we check conditions before heading out on moving day. The road is well-maintained and handles a large truck without issues. Within the suburb, streets are quiet with very little traffic. Most driveways are wide enough for truck access, and turning space is adequate at the road ends. The distance from the CBD adds about 15 minutes to the drive compared to a North Ward or Belgian Gardens move, which we factor into the quote. During cyclone season, Pallarenda is exposed and can cop storm surge â€” residents need to plan for early evacuation, and we recommend having an emergency plan for your belongings if you live on the low-lying foreshore blocks.",
    ...
    moveDay:
      "Pallarenda jobs are a nice change of pace from the hectic inner-city moves. We did one recently â€” a retired couple moving from a raised timber home on one of the foreshore streets to a low-set brick place in Mundingburra. They had lived in Pallarenda for 15 years and the house reflected it â€” every room full, a workshop under the house, and enough fishing gear in the carport to stock a tackle shop.\n\nWe drove out along Pallarenda Road at 6:45am â€” clear run, no traffic. The house was raised about a metre on concrete stumps with a solid timber staircase and a wide front deck. Good access, no issues parking the large truck in the driveway. The views across to Magnetic Island from the front deck were something else.\n\nStarted loading the workshop and carport first â€” toolboxes, a workbench, fishing rods in protective tubes, tackle boxes, camping gear. Under-house stuff filled a good section of the truck. Upstairs, the furniture was solid timber â€” heavy but well-made. The dining table needed six hands to get down the front stairs safely. Beds, wardrobes, a piano that had been in the family for decades â€” every item wrapped in blankets and strapped properly.\n\nThe salt air had done a number on the outdoor setting â€” corroded legs, chalky surfaces. We wrapped each piece individually and loaded them against the truck wall with extra padding. Loaded and rolling by 11am. The drive to Mundingburra took about 20 minutes. New house was ground-level with a double garage â€” unloaded and placed by 2pm. The piano went into the lounge room first, then everything else arranged around it. The bloke said it was the first time in 15 years they had not been able to hear the waves. Bittersweet, but they were happy with the move.",
    localFaqs: [
      {
        question: "Does the single road access to Pallarenda affect moving logistics?",
        answer:
          "There is only one road in and out â€” Pallarenda Road. We check for any roadworks or closures before heading out on the day. In practice, the road is well-maintained and handles our trucks without issues. The extra distance from the CBD adds about 15 minutes each way, which we factor into the quote.",
      },
      {
    ...
    tips: [
      {
        ...
        text: "There is one road in and one road out. If roadworks or a tree is blocking Pallarenda Road, it affects our access. Check council notices in the week before your move and let us know if anything is scheduled â€” we can adjust timing if needed.",
      },
      {
        heading: "Wrap and protect salt-corroded outdoor items.",
        text: "Living on the coast means your outdoor furniture and metal items have copped years of salt spray. Point out any corroded or fragile pieces to our crew so we can wrap them with extra padding â€” handling corroded metal without protection can cause further damage or injury.",
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      "Garbutt removalists â€” fast, affordable, fully insured. Flat access, defence family specialists, no hidden fees. Get your free quote from R2G now.",
    moveDay:
      "Garbutt jobs are efficient by nature â€” flat blocks, ground-level access and straightforward homes. We did a job last week for an RAAF family being posted from Townsville to Amberley in Queensland. Three-bedroom brick home on a quiet street backing onto the airport perimeter fence. Standard defence housing layout â€” you could walk through it with your eyes closed if you have moved enough military families.\n\nTwo blokes and a medium truck, 7am start. The family had done their fair share of moves and were well prepared â€” everything boxed, labelled and stacked in the garage. The house was clean and simple: three bedrooms of standard furniture, a small dining table, a lounge suite, and the usual kitchen and laundry items. No stairs, no tight hallways, no heritage doorways to wrestle with.\n\nWe loaded the garage contents first â€” moving boxes stacked six high on the truck, then the outdoor items and kids bikes. Inside the house, beds came apart quickly, mattresses into bags, wardrobe contents into portable wardrobes. The entire house was on the truck by 9:30am. Two and a half hours for a three-bedroom â€” that is what happens when the access is good and the clients are organised.\n\nThis load was heading to our depot for an interstate transfer to Brisbane, so we sealed the truck, documented the inventory and gave the family their paperwork. They flew out that afternoon. Their belongings arrived at the Amberley end four days later. Defence postings are a big part of our Garbutt work and we have the process dialled in.",
    localFaqs: [
      {
      ...
      },
      {
        ...
        answer:
          "The airport is adjacent to Garbutt, so there is periodic flight noise. It does not affect the move itself â€” our crew is used to it. If you are moving into Garbutt and are noise-sensitive, visit the property at different times of day before committing to get a feel for the flight path activity.",
      },
      {
    ...
    serviceSummary:
      "Garbutt moves are quick and efficient thanks to the flat terrain, wide streets and ground-level homes. We handle a high volume of defence family relocations in this area â€” both local moves and interstate postings â€” and have the process refined to minimise downtime between the march-out and the flight. For interstate transfers, we provide sealed truck loads with documented inventories. Standard Garbutt moves typically need a two-person crew and a medium truck, keeping costs down for budget-conscious movers.",
    reviews: [
      {
        ...
        name: "Bec & Dan M.",
        location: "Garbutt â†’ Brisbane",
        date: "January 2025",
      },
      {
        text: "Quick and cheap â€” moved from a unit in Garbutt to a house in Aitkenvale. Two blokes had it done in two hours flat. No damage, no drama. Best value removalists I have used in Townsville.",
        name: "Ryan S.",
        location: "Garbutt â†’ Aitkenvale",
        date: "October 2024",
      },
      {
        text: "We bought our first home in Garbutt and R2G moved us from a rental in Hermit Park. The crew were friendly, fast and treated our stuff with care. Really happy with the service â€” highly recommend for anyone on a budget.",
        name: "Amy & Tom C.",
        location: "Garbutt",
        date: "July 2024",
      },
    ...
    tips: [
      {
        ...
        text: "Garbutt homes have great garage and carport access. If you stack your packed boxes in the garage the night before, our crew can start loading immediately from the truck tailgate without entering the house first â€” it shaves 30 minutes off the job easily.",
      },
      {
      ...
      },
      {
        ...
        text: "If your move is interstate â€” common for defence postings â€” prepare an inventory list of all items and their condition before we arrive. We document everything on our end too, but having your own record gives you peace of mind and simplifies any insurance claims.",
      },
      {
...
/** Map of suburb display name â†’ route path for suburbs that have a built page. */
